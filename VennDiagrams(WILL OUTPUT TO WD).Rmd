...
## Venn Diagrams (files output to WD)
...
```{r}
 ...
 venn.diagram(
   x = list(
      "F36" = genesAll$res1F_WT36,
      "M36" = genesAll$res1M_WT36,
      "F41" = genesAll$res1F_WT41,
      "M41" = genesAll$res1M_WT41
    ),
    filename = "TP1_3641.png",
    col = "black",
    fill = c("red", "green", "blue", "cyan"),
    alpha = 0.5,
    cex = 1.5,
    cat.cex = 1.5,
    cat.col = c("red", "green", "blue", "cyan")
  )
  
  venn.diagram(
    x = list(
      "F36" = genesAll$res2F_WT36,
      "M36" = genesAll$res2M_WT36,
      "F41" = genesAll$res2F_WT41,
      "M41" = genesAll$res2M_WT41
    ),
    filename = "TP2_3641.png",
    col = "black",
    fill = c("red", "green", "blue", "cyan"),
    alpha = 0.5,
    cex = 1.5,
   ...
   venn.diagram(
    x = list(
      "F36" = genesAll$res3F_WT36,
      "M36" = genesAll$res3M_WT36,
      "F41" = genesAll$res3F_WT41,
      "M41" = genesAll$res3M_WT41
    ),
    filename = "TP3_3641.png",
    col = "black",
    fill = c("red", "green", "blue", "cyan"),
    alpha = 0.5,
    cex = 1.5,
