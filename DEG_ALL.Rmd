...
genespAll = lapply(reList, pdegenes, lfcThreshold = 2, padjThreshold = 0.05, max = NULL)

genesnAll = lapply(reList, ndegenes, lfcThreshold = -2, padjThreshold = 0.05, max = NULL)

genesAll = lapply(reList, degenes, lfcThreshold = 2, padjThreshold = 0.05, max = NULL)
...
outputTidy(genesAll, "DEG_ALL.csv")
outputTidy(genespAll, "DEG_P_ALL.csv")
outputTidy(genesnAll, "DEG_N_ALL.csv")
