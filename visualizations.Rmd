...
plotCounts(dds1F_WT36, gene = "Carhsp1", intgroup = "l1F_WT36")

plotCounts(dds2F_WT36, gene = "Bysl", intgroup = "l2F_WT36")
plotCounts(dds2M_WT36, gene = "Bysl", intgroup = "l2M_WT36")

plotCounts(dds2F_WT36, gene = "Eif4g1", intgroup = "l2F_WT36")
plotCounts(dds2M_WT36, gene = "Eif4g1", intgroup = "l2M_WT36")
...
## Venn Diagrams (uncomment to have files output to WD)
...
## Pie charts of RBPs (depends on RBP and ALL DEGs .csv files having already been formatted in excel)

```{r}
RBPall = read.csv(file = "DEG_rbps.csv",sep = ";")
DEGall = read.csv(file = "DEG_ALL.csv", sep = ";")
```

```{r}
ratio = function(x){
  
  full = na.omit(DEGall[[x]])
  
  rbp = na.omit(RBPall[[x]])
