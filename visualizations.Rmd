...
install.packages(c('dplyr','readxl','DESeq2','ggplot2', 'VennDiagram'), repos = "http://cran.us.r-project.org" )
```
...
#Binding final objects for comparison between different conditions (Timepoint-Sex-Line-conditions)
...
## Simple XY (difference visualization)
...
```{r}
plot(logrbps$'1FWT_1', logrbps$'1FWT_2', xlim = c(0,20), ylim = c(0,20))
plot(logrbps$'1FWT_1', logrbps$'1FWT_3', xlim = c(0,20), ylim = c(0,20))
plot(logrbps$'1FWT_2', logrbps$'1FWT_3', xlim = c(0,20), ylim = c(0,20))

plot(logrbps$'1FWT_1', logrbps$'3M36_1', xlim = c(0,20), ylim = c(0,20))
...
## REMEMBER TO REFERENCE ALEX SOUPIR FOR FUNCTIONS BELOW
...
plotCounts(res1F_WT36, gene = "Nop58", intgroup = "l1F_WT36")
...
venn.diagram(
  x = list(
    "M" = genesAll$res1M_WT36,
    "F" = genesAll$res1F_WT36
  ),
  filename = "t1sex36.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "M" = genesAll$res2M_WT36,
    "F" = genesAll$res2F_WT36
  ),
  filename = "t2sex36.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "M" = genesAll$res3M_WT36,
    "F" = genesAll$res3F_WT36
  ),
  filename = "t3sex36.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "T1" = genesAll$res1F_WT36,
    "T2" = genesAll$res2F_WT36,
    "T3" = genesAll$res3F_WT36
  ),
  filename = "tpF36.png",
  col = "black",
...
venn.diagram(
  x = list(
    "T1" = genesAll$res1M_WT36,
    "T2" = genesAll$res2M_WT36,
    "T3" = genesAll$res3M_WT36
  ),
  filename = "tpM36.png",
  col = "black",
  fill = c("red", "green", "blue"),
...
venn.diagram(
  x = list(
    "M" = genesAll$res1M_WT41,
    "F" = genesAll$res1F_WT41
  ),
  filename = "t1sex41.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "M" = genesAll$res2M_WT41,
    "F" = genesAll$res2F_WT41
  ),
  filename = "t2sex41.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "M" = genesAll$res3M_WT41,
    "F" = genesAll$res3F_WT41
  ),
  filename = "t3sex41.png",
  col = "black",
  fill = c("red", "green"),
  alpha = 0.5,
  cex = 1.5,
...
venn.diagram(
  x = list(
    "T1" = genesAll$res1F_WT41,
    "T2" = genesAll$res2F_WT41,
    "T3" = genesAll$res3F_WT41
  ),
  filename = "tpF41.png",
  col = "black",
  fill = c("red", "green", "blue"),
...
venn.diagram(
  x = list(
    "T1" = genesAll$res1M_WT41,
    "T2" = genesAll$res2M_WT41,
    "T3" = genesAll$res3M_WT41
  ),
  filename = "tpM41.png",
  col = "black",
  fill = c("red", "green", "blue"),
