...
pink = module_eigengenes$MEpink
yellow = module_eigengenes$MEyellow
...
```{r}
corPink = cor.test(pink, traits$c36_bin)

pPink = corPink$p.value

pPink
```

```{r}
corYellow = cor.test(yellow, traits$c36_bin)

pYellow = corYellow$p.value
