...
### Comparing WT and TG mice (positively and negatively DE genes and then all)

```{r}
BPGOP1F_WTG = (summary(go_PDE(sigRes$res1F_WTG)))
BPGOP1M_WTG = (summary(go_PDE(sigRes$res1M_WTG)))
BPGOM1F_WTG = (summary(go_NDE(sigRes$res1F_WTG)))
BPGOM1M_WTG = (summary(go_NDE(sigRes$res1M_WTG)))

BPGOP2F_WTG = (summary(go_PDE(sigRes$res2F_WTG)))
BPGOP2M_WTG = (summary(go_PDE(sigRes$res2M_WTG)))
BPGOM2F_WTG = (summary(go_NDE(sigRes$res2F_WTG)))
BPGOM2M_WTG = (summary(go_NDE(sigRes$res2M_WTG)))

BPGOP3F_WTG = (summary(go_PDE(sigRes$res3F_WTG)))
BPGOP3M_WTG = (summary(go_PDE(sigRes$res3M_WTG)))
BPGOM3F_WTG = (summary(go_NDE(sigRes$res3F_WTG)))
BPGOM3M_WTG = (summary(go_NDE(sigRes$res3M_WTG)))
...
CCGOM1F_WTG = summary(go_NDE(sigRes$res1F_WTG, ont = "CC"))
CCGOM1M_WTG = summary(go_NDE(sigRes$res1M_WTG, ont = "CC"))

CCGOP2F_WTG = summary(go_PDE(sigRes$res2F_WTG, ont = "CC"))
CCGOP2M_WTG = summary(go_PDE(sigRes$res2M_WTG, ont = "CC"))
CCGOM2F_WTG = summary(go_NDE(sigRes$res2F_WTG, ont = "CC"))
CCGOM2M_WTG = summary(go_NDE(sigRes$res2M_WTG, ont = "CC"))

CCGOP3F_WTG = summary(go_PDE(sigRes$res3F_WTG, ont = "CC"))
CCGOP3M_WTG = summary(go_PDE(sigRes$res3M_WTG, ont = "CC"))
CCGOM3F_WTG = summary(go_NDE(sigRes$res3F_WTG, ont = "CC"))
CCGOM3M_WTG = summary(go_NDE(sigRes$res3M_WTG, ont = "CC"))
...
MFGOM1F_WTG = summary(go_NDE(sigRes$res1F_WTG, ont = "MF"))
MFGOM1M_WTG = summary(go_NDE(sigRes$res1M_WTG, ont = "MF"))

MFGOP2F_WTG = summary(go_PDE(sigRes$res2F_WTG, ont = "MF"))
MFGOP2M_WTG = summary(go_PDE(sigRes$res2M_WTG, ont = "MF"))
MFGOM2F_WTG = summary(go_NDE(sigRes$res2F_WTG, ont = "MF"))
MFGOM2M_WTG = summary(go_NDE(sigRes$res2M_WTG, ont = "MF"))

MFGOP3F_WTG = summary(go_PDE(sigRes$res3F_WTG, ont = "MF"))
MFGOP3M_WTG = summary(go_PDE(sigRes$res3M_WTG, ont = "MF"))
MFGOM3F_WTG = summary(go_NDE(sigRes$res3F_WTG, ont = "MF"))
MFGOM3M_WTG = summary(go_NDE(sigRes$res3M_WTG, ont = "MF"))
...
BPGOM1F_3641 = summary(go_NDE(sigRes$res1F_3641))
BPGOM1M_3641 = summary(go_NDE(sigRes$res1M_3641))

BPGOP2F_3641 = summary(go_PDE(sigRes$res2F_3641))
BPGOP2M_3641 = summary(go_PDE(sigRes$res2M_3641))
BPGOM2F_3641 = summary(go_NDE(sigRes$res2F_3641))
BPGOM2M_3641 = summary(go_NDE(sigRes$res2M_3641))

BPGOP3F_3641 = summary(go_PDE(sigRes$res3F_3641))
BPGOP3M_3641 = summary(go_PDE(sigRes$res3M_3641))
BPGOM3F_3641 = summary(go_NDE(sigRes$res3F_3641))
BPGOM3M_3641 = summary(go_NDE(sigRes$res3M_3641))
...
BPGO1M_3641 = summary(allgo(sigRes$res1M3641))
