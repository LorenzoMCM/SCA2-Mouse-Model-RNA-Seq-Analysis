...
```{r}
greenMod = read.csv("green36Mod.csv")
greenMod = as.data.frame(greenMod$rownames.kWithin_sorted.)
colnames(greenMod) = "Gene_Symbol"

pinkMod = read.csv("pink36Mod.csv")
pinkMod = as.data.frame(pinkMod$pinkMod)
colnames(pinkMod) = "Gene_Symbol"

yellowMod = read.csv("yellow36Mod.csv")
yellowMod = as.data.frame(yellowMod$rownames.kWithin_sorted.)
colnames(yellowMod) = "Gene_Symbol"

modList = list(greenMod, pinkMod, yellowMod)
...
BPpink = modgo(modList[[2]]$Gene_ID)
BPyellow = modgo(modList[[3]]$Gene_ID)
```
...
CCpink = modgo(modList[[2]]$Gene_ID, ont = "CC")
CCyellow = modgo(modList[[3]]$Gene_ID, ont = "CC")
```
...
MFpink = modgo(modList[[2]]$Gene_ID, ont = "MF")
MFyellow = modgo(modList[[3]]$Gene_ID, ont = "MF")
```
